...
public class DtmJson {
    ...
    public static class Endpoint {
        ...
        public List<Contato> getContatosOrigem() {
          return ContatosOrigem;
        }
        public void setContatosOrigem(List<Contato> contatosOrigem) {
          ContatosOrigem = contatosOrigem;
        }
        public List<Contato> getContatosDestino() {
          return ContatosDestino;
        }
        public void setContatosDestino(List<Contato> contatosDestino) {
          ContatosDestino = contatosDestino;
        }
    ...
    public static class Carga {
        ...
        public void setPesoTaxado(Double pesoTaxado) {
